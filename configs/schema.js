...
export const products = pgTable('products', {
  ...
  sellerId: integer('seller_id').notNull().references(() => users.id), // Reference to seller
...
export const orders = pgTable('orders', {
  ...
  userId: integer('user_id').notNull().references(() => users.id), // Reference to buyer
...
export const payments = pgTable('payments', {
  id: serial('id').primaryKey(),
  orderId: integer('order_id').notNull().references(() => orders.id).unique(), // One payment per order
