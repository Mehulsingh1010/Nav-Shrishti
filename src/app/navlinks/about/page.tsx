...
नव सृस्टी सृजन सेवा संघ एक स्वयं सेवी संस्था है।
जिसकी स्थापना ४ अप्रेल २०२५ को भारतीय संस्कृति, आयुर्वेद, वैदिक शिक्षा, परंपरागत व्यवसाय एवं सनातन धर्म के संरक्षण एवं प्रचार-प्रसार के लिये की गई है। इसके संस्थापक श्री गुरुदेव पंकज आनन्द नामदेव जी महाराज हैं ।
नव सृस्टी सृजन सेवा संघ देश के बिभिन्न भागों में वैदिक गुरुकुल शिक्षा केन्द्र, बाल संस्कार केन्द्र, स्वास्थ्य शिविर, आश्रय गृह, वैदिक धर्म अनुस्ठान केन्द्र, परंपरागत व्यवसायिक प्रशिक्षण केन्द्र, सांस्कृतिक उत्सव एवं लोक कल्याण के क्षेत्र में
कार्यरत है।
</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <Card className="border-orange-200 shadow-md hover:shadow-lg transition-all hover:border-orange-300">
              <CardContent className="p-8">
                ...
                हमारा लक्ष्य वैदिक शिक्षा, सनातन संस्कृति व परंपरागत व्यवसायों के पुनरुत्थान के माध्यम से लोगों को शारीरिक, मानसिक, आर्थिक एवं अध्यात्मिक रुप से सशक्त बनाकर उनके जीवन में स्वास्थ्य, धन एवं खुशहाली लाना है।
हमारा दृश्टिकोंण प्राचीन वैदिक ज्ञान और आधुनिक विज्ञान के बीच एक सेतु बनकर भारत और विश्व में वैदिक शिक्षा व जीवन शैली को बढ़ावा देने वाली स्वयं सेवी संस्था के रुप में उभरेंगे, जिससे एक स्वस्थ्य, समृद्ध एवं खुशहाल समाज का निर्माण हो सके।                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid md:grid-cols-12 gap-8 items-center max-w-5xl mx-auto">
            <div className="md:col-span-4">
              ...
              <div className="text-center mt-4">
                <h3 className="text-xl font-bold text-orange-800">Shree Gurudev Pankaj Aanad Namdev Ji Maharaj</h3>
