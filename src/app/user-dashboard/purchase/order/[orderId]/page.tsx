...
import { DashboardShell } from "@/app/user-dashboard/_components/dashboard-shell";
...
function getStatusBadge(status: "pending" | "processing" | "completed" | "cancelled") {
  const statusClasses = {
...
function translateStatus(status: "pending" | "processing" | "completed" | "cancelled") {
  const translations = {
    pending: "लंबित",
...
export default async function OrderDetailPage({ params }: { params: { orderId: string } }) {
  // Get the token cookie - This matches your login logic from PurchaseHistoryPage
  ...
  }) as { status: "pending" | "processing" | "completed" | "cancelled"; userId: number; id: number; orderId: string } | null;
