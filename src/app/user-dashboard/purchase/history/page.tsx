...
import { InvoiceButton } from "@/components/InvoiceButton"; // Import the new component
              ...
              <CardContent>
                ...
                <div className="p-4 bg-gray-50 flex flex-wrap justify-between">
                  ...
                  <div className="flex gap-2">
                    {/* Only show invoice button if payment is captured */}
                    {order.payment?.status === "captured" && (
                      <InvoiceButton 
                        ...
                        customerName={`${user.firstName} ${user.surname}`.trim() || user.email}
                        customerEmail={user.email}
                        customerAddress={`${user.addressLine1}, ${user.addressLine2 || ''}, ${user.city}, ${user.state}`}
                        gstin="27AADCB2230M1ZT" // Replace with your company's GSTIN
                      />
                    )}
