  ...
  return (
    <div className="container mx-auto py-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <Button className="bg-[#F05A28] hover:bg-[#D04A18]">Save Changes</Button>
      </div>
              ...
              <TabsContent value="personal" className="space-y-6 pt-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="email" type="email" defaultValue="singh@gmail.com" />
                  </div>
              ...
              <TabsContent value="nominee" className="space-y-6 pt-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="nomineeDob" type="date" defaultValue="1992-08-20" />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <Input id="nomineeAddress" defaultValue="123 Main Street, Apartment 4B, Mumbai" />
                  </div>
                </div>
              </TabsContent>
